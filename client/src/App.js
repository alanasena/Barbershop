...
import BarberAppointments from './components/Barber/BarberAppointments/BarberAppointments'
    ...
    <div className="App">
      <Router>
        <Switch>
          ...
          <ProtectedRoute component={BarberAppointments} path='/barber/appointments' />
